...
The basics of rendering involves a view, a camera, and a collection of props. The `BASceneView` class is a subclass of `NSOpenGLView`. It provides basic support for mouse and WSAD-based keyboard control, so you can fly around your scene as though you were in a game.
